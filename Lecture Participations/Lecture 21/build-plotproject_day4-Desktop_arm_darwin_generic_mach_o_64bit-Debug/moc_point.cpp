...
#include <memory>
#include "../ploproject_day4/point.h"
...
void Point::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->DrawLine((*reinterpret_cast< Point*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Point::*)(Point * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Point::DrawLine)) {
                *result = 2;
                return;
            }
        }
